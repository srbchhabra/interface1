...
const simulateClick = (e) => {
  ...
  imageInput.dispatchEvent((new MouseEvent("click", opts)));
}

const uploadFile =(e) => {
const files = Array.from(e.target.files);

const imageURL = `images/${files[0].name}`;
...
<span id="fileup" onClick={simulateClick}>Upload File</span>
<input ref={el => (imageInput=el)} type = "file" name ="photo" id="imageInput" accept="image/*" onChange={uploadFile}></input>     
